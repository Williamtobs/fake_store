...
class _CartClient implements CartClient {
  ...
  Future<CartsResponse> getCarts(int id) async {
    ...
    final _options = _setStreamType<CartsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CartsResponse _value;
    try {
      _value = CartsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<void> updateCarts(
    int id,
    dynamic cartsResponse,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = cartsResponse;
